...
import static com.wekex.apps.bluetoothremote.helper.jsonhelper.view_json_info_editor;
import static com.wekex.apps.bluetoothremote.helper.jsonhelper.view_json_row_info;

public class view_move_zoom_rotate implements View.OnTouchListener {
    ...
    public view_move_zoom_rotate(Activity activity) {
        context = activity;
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (lastAction == MotionEvent.ACTION_MOVE) {
                    Log.d(TAG, params.leftMargin+" "+params.topMargin+" "+view.getHeight()+" "+view.getWidth()+" "+angle);
                    JSONObject jsonObject = view_json_info_editor(pxtoDp(params.leftMargin, context), pxtoDp(params.topMargin, context),pxtoDp(view.getScrollY(), context),pxtoDp(view.getScrollX(), context),angle);

                    getDB(context).updateLayout(ID, addToButtonArrays(Integer.parseInt(view.getTag().toString()),jsonObject));
                }
